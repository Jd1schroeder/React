...
begin
  ...
  insert into public.organization_members (
    ...
    invitation.organization_id, auth.uid(), invitation.role, 'active', invitation.invited_by, invitation.invited_at, now()
  )
  ...
  values (invitation.organization_id, auth.uid(), 'accepted', 'organization_invitation', invitation.id, jsonb_build_object('role', invitation.role));
