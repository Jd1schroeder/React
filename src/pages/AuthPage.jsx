...
function Brand() {
  return <div className="login-brand login-brand-light"><img className="login-brand-mark" src={workbenchIcon} alt="" /><span>Workbench</span></div>
}
      ...
      <main className="signup-page">
        ...
        <section className="signup-panel" aria-labelledby="auth-title">
          <div className="signup-card">
            <img className="signup-card-logo" src={workbenchLogo} alt="Workbench CMMS" />
  ...
  return (
    <main className="login-page">
      <section className="login-hero" aria-label="Workbench facility operations">
        ...
        <div className="login-hero-content"><Brand /><div><p className="login-hero-kicker">FACILITY OPERATIONS</p><h2>Keep every team,<br />tool, and task moving.</h2><p className="login-hero-copy">One clear workspace for the work that keeps your facility running.</p></div><div className="login-hero-illustration" aria-hidden="true"><div className="illustration-building"><span /><span /><span /><span /><span /><span /></div><div className="illustration-floor" /><div className="illustration-tool illustration-tool-one" /><div className="illustration-tool illustration-tool-two" /></div></div>
      </section>
