...
export function PreventiveMaintenance({ recordId }) {
  const pmSchedules = []
  ...
  return <PanelView title="Maintenance Plans" searchPlaceholder="Search Maintenance Plans" actionLabel="Create schedule" filters={['Asset', 'Frequency', 'Status']} items={items} kind="schedule" recordId={recordId} />
}
